...
void setIMR(uint8 val)
{
    IINCHIP_WRITE(IMR,val);
}
/****×é²¥*****/
void setDIPR(
  SOCKET n,uint8 * addr  /**< a pointer to a 4 -byte array responsible to set the Source IP address. */
  )
{
